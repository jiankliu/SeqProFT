...
from esm_next.models.function_decoder import FunctionTokenDecoder
from esm_next.models.vqvae import StructureTokenDecoder
from esm_next.sdk.api import ESMProtein, ESMProteinTensor
from esm_next.tokenization import TokenizerCollectionProtocol
from esm_next.tokenization.function_tokenizer import (
    InterProQuantizedTokenizer,
)
from esm_next.tokenization.residue_tokenizer import (
    ResidueAnnotationsTokenizer,
)
from esm_next.tokenization.sasa_tokenizer import (
    SASADiscretizingTokenizer,
)
from esm_next.tokenization.sequence_tokenizer import (
    EsmSequenceTokenizer,
)
from esm_next.tokenization.ss_tokenizer import (
    SecondaryStructureTokenizer,
)
from esm_next.tokenization.structure_tokenizer import (
    StructureTokenizer,
)
from esm_next.tokenization.tokenizer_base import EsmTokenizerBase
from esm_next.utils.constants import esm3 as C
from esm_next.utils.function.encode_decode import (
    decode_function_tokens,
    decode_residue_annotation_tokens,
)
from esm_next.utils.misc import maybe_list
from esm_next.utils.structure.protein_chain import ProteinChain
from esm_next.utils.types import FunctionAnnotation
