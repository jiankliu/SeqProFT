...
from esm_next.layers.attention import MultiHeadAttention
from esm_next.layers.geom_attention import (
...
class UnifiedTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        """
        attn_weights = None
        if self.use_plain_attn:  # True
            r1, attn_weights = self.attn(x, sequence_id)
        ...
        return x, attn_weights  # (bs, n_heads, seq_len+2, seq_len+2)
